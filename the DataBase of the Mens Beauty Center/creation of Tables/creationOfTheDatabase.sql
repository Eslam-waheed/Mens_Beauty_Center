...
(
  ...
  NationalID char(14) check (len(NationalID)=14 and NationalID like '[0-9]%') primary key,
...
create table PackageCustomer (
	...
	NationalID char(14) check (len(NationalID)=14 and NationalID like '[0-9]%') foreign key references Employee(NationalId),
    TakeDate date not null,
    primary key (CustomerId, PackageId, NationalID)
);
